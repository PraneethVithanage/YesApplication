...
extension URLRequest {
    ...
    static public func getFormMstudio () -> URLRequest {
        var component: URLComponents?
        component = URLComponents(string:"http://mbcapps.mstudio.live:8081/yesservice/DbService.asmx/GetOnAirDetails?nPrvSongs=1&nNextSongs=1")
